...
const Locations = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="Driveway Service Areas - Sydney Locations | Driveways Sydney"
        description="Professional driveway construction services across all Sydney areas. The Hills District, North Shore, Eastern Suburbs, Inner West, and more."
        keywords="driveway service areas sydney, hills district driveways, north shore driveways, eastern suburbs driveways, sydney driveway locations"
        ogTitle="Driveway Service Areas - Sydney Locations"
        ogDescription="Find our professional driveway services in your Sydney area. Quality construction across all suburbs."
