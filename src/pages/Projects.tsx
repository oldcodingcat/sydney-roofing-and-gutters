...
const Projects = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEOHead
        title="Driveway Projects - Completed Works in Sydney | Driveways Sydney"
        description="Browse our completed driveway projects across Sydney. From residential to commercial, see our expertise in action."
        keywords="driveway projects sydney, completed driveways, concrete driveway examples, paver driveway projects, residential driveways"
        ogTitle="Driveway Projects - Our Completed Works"
        ogDescription="Discover our completed driveway projects showcasing quality craftsmanship and design excellence."
