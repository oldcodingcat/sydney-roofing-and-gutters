...
const RoofersIslington = () => {
  // Services Array (roofing)
  const services = [
    {
      icon: <Hammer className="h-8 w-8" />,
      title: "Roof Repairs",
      description: "Emergency repairs and maintenance for Islington properties",
      link: "/roof-repairs"
    },
    {
    ...
    },
    {
      ...
      description: "24/7 emergency roofing service in Islington",
  ...
  const whyChooseReasons = [
    {
      ...
      description: "15+ years serving Islington and surrounding Newcastle suburbs"
    },
    {
      title: "24/7 Emergency Service",
      description: "Round-the-clock emergency repairs for Islington residents"
    },
    {
  ...
  // Suburbs list
  const suburbs = [
    "Wickham", "Tighes Hill", "Hamilton", "Georgetown",
    "Waratah", "Mayfield", "Carrington", "Newcastle West",
    "Jesmond", "Lambton", "Broadmeadow", "Stockton"
  ];
  ...
  const testimonials = [
    {
      ...
      location: "Islington",
      rating: 5,
      text: "Excellent roofing service! They responded quickly to our emergency leak and fixed it professionally. Highly recommend for Islington residents."
    },
    {
      name: "Lisa Chen",
      location: "Islington",
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        ogDescription="Expert roofing services in Islington. Emergency repairs, replacements, and restorations. Available 24/7."
        ogImage="https://newcastlelocalroofers.com.au/images/roof-repairs-newcastle.jpg"
        schemaType="RoofingContractor"
        location="newcastle"
        customName="Roofers in Islington"
        customDescription="Professional roofing services in Islington, Newcastle NSW"
      />
      <Header />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <Badge variant="secondary" className="mb-4 bg-white/10 text-white border-white/20">
              Islington Roofing Specialists
            </Badge>
            <h1 className="text-3xl md:text-5xl font-bold mb-6">
              Professional Roofers in Islington
            </h1>
            <p className="text-lg md:text-xl mb-8 opacity-90">
              24/7 emergency roofing services for Islington and surrounding Newcastle areas
            </p>
            <div className="flex flex-wrap justify-center gap-6 text-sm md:text-base">
              <div className="flex items-center gap-2">
                <MapPin className="h-5 w-5" />
                <span>Serving Islington</span>
              </div>
              <div className="flex items-center gap-2">
      ...
      {/* About Roofing in Islington */}
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              <h2 className="text-3xl md:text-4xl font-bold text-primary mb-6">
                Professional Roofing Services in Islington
              </h2>
              ...
              <p className="text-base leading-relaxed mb-6" style={{color: '#666666'}}>
                We understand the unique roofing challenges that Islington properties face. With its industrial heritage and renovated warehouses, we specialize in both heritage roof restoration and modern commercial roofing solutions.
              </p>

              <div className="bg-muted/30 p-6 rounded-lg mb-6">
                <h3 className="text-xl font-semibold text-primary mb-4">
                  Why Islington Residents Choose Us
                </h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                    <span style={{color: '#666666'}}>
                      <strong>24/7 Emergency Response:</strong> When you need urgent roof repairs in Islington, we're available around the clock to prevent further damage to your property.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                    <span style={{color: '#666666'}}>
                      <strong>Local Knowledge:</strong> As Islington specialists, we understand local building codes, weather patterns, and common roofing issues in the area.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                    <span style={{color: '#666666'}}>
                      <strong>Competitive Pricing:</strong> We offer transparent, no-obligation quotes for all roofing services in Islington, with no hidden costs.
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-3">Common Roofing Needs in Islington</h3>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-6">
              Additional Information About Islington
            </h2>
            
            <div className="prose prose-lg max-w-none">
              <p className="text-base leading-relaxed mb-6" style={{color: '#666666'}}>
                Islington is a heritage industrial suburb located in inner Newcastle, northwest of the CBD. Known for its industrial heritage and renovated warehouses, the area attracts young professionals and artists who value character, affordability and city access.
              </p>

              <h3 className="text-xl font-semibold text-primary mb-4">
                Common Roofing Issues in Islington
              </h3>
              <p className="text-base leading-relaxed mb-4" style={{color: '#666666'}}>
                Due to Islington's inner-city location with mixed development, properties in the area commonly experience:
              </p>
              <ul className="space-y-2 mb-6">
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                  <span style={{color: '#666666'}}>
                    <strong>Weather-related damage:</strong> Industrial building roof maintenance and repairs
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                  <span style={{color: '#666666'}}>
                    <strong>Material deterioration:</strong> Heritage roof restoration on older properties
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                  <span style={{color: '#666666'}}>
                    <strong>Structural concerns:</strong> Modern commercial roofing and waterproofing
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-primary/5 border-l-4 border-primary p-6 rounded-r-lg mb-6">
                <h4 className="text-lg font-semibold text-primary mb-2">
                  Fast Response for Islington Residents
                </h4>
                <p className="text-base leading-relaxed" style={{color: '#666666'}}>
                  We understand that roofing emergencies can't wait. That's why we offer 24/7 emergency service to Islington and surrounding suburbs. Call us anytime on <a href="tel:0240894613" className="text-primary font-semibold hover:underline">(02) 4089 4613</a> for immediate assistance.
                </p>
              </div>
              ...
              <p className="text-base leading-relaxed mb-6" style={{color: '#666666'}}>
                Islington is easily accessible from Maitland Road or Hannell Street. Our roofing team services Islington regularly and can typically arrive on-site within 15-20 minutes for emergency calls, or schedule convenient appointments for inspections and quotes.
              </p>
            </div>
          </div>
        </div>
...
export const route = {
  path: "/roofers-islington/",
  element: <RoofersIslington />,
  handle: {
    title: "Roofers in Islington | 24/7 Emergency Service",
    meta: [
      { name: "description", content: "Professional roofing services in Islington, Newcastle. Emergency repairs, roof replacement, restoration. Licensed & insured. Call (02) 4089 4613 for free quote." }
    ]
  }
};

export default RoofersIslington;
