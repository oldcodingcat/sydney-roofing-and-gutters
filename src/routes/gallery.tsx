...
const GalleryPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEOHead 
        title="Our Work Gallery | Driveways Sydney Projects"
        description="Explore our portfolio of beautifully designed and expertly constructed driveways across Sydney's finest suburbs. See before/after photos and project details."
        keywords="driveway gallery, Sydney driveways, concrete driveways, paver driveways, natural stone driveways, driveway projects, before after photos"
        ogTitle="Our Work Gallery | Driveways Sydney Projects"
        ogDescription="Explore our portfolio of beautifully designed and expertly constructed driveways across Sydney's finest suburbs. See before/after photos and project details."
        schemaType="LocalBusiness"
        location="newcastle"
        customName="Driveways Sydney"
        customDescription="Professional driveway construction services in Sydney - View our project gallery"
      />
      <Header />
...
export const route: Route = {
  ...
  handle: {
    title: "Our Work Gallery | Driveways Sydney Projects",
    meta: [
      { name: "description", content: "Explore our portfolio of beautifully designed and expertly constructed driveways across Sydney's finest suburbs. See before/after photos and project details." },
      { name: "keywords", content: "driveway gallery, Sydney driveways, concrete driveways, paver driveways, natural stone driveways, driveway projects, before after photos" }
    ]
  }
};
